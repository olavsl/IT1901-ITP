 ...
 * 2. Run the command "mvn install". If you can't install because of test failures, try running "mvn install -DskipTests"
 ...
 * 7. Now the app should appear on your screen. Database (JSON) can be viewed in the web browser by going to "http://localhost:8080/personal_finance/"
 */
