...
public class OverviewController extends SceneSwitcher {
  ...
  @FXML
  private Label totLife;
  @FXML
  private Label totMonth;
  @FXML
  private Label budgetCompliance;
  @FXML
  private TableView<Transaction> transactionOverview;
  @FXML
  private TableColumn<Transaction, String> transactionTitles;
  @FXML
  private TableColumn<Transaction, Double> transactionAmounts;
  @FXML
  private TableColumn<Transaction, String> transactionDates;
  @FXML
  private Label usernameDisplay;
  @FXML
  private ChoiceBox<String> btnFilterByCategory;
