...
public class PersonalFinancePersistence {
  ...
  public PersonalFinanceModel readPersonalFinanceModel(Reader reader)
      throws StreamReadException, DatabindException, IOException {
    return mapper.readValue(reader, PersonalFinanceModel.class);
  }

  public void writePersonalFinanceModel(PersonalFinanceModel personalFinanceModel, Writer writer)
      throws StreamWriteException, DatabindException, IOException {
    mapper.writerWithDefaultPrettyPrinter().writeValue(writer, personalFinanceModel);
  }

  /**
   * @return PersonalFinanceModel - which carries the information of users in the
   *         database.
   * @throws IOException
   */
